...
Tab:AddMultiDropdown("Left", "Select Farm", {"Missing", "Create", "Cooked", "Fire", "All"}, "Easy", function(choice)
end)
Tab:AddMultiDropdown("Left", "Select Mode", {"Kaitun", "Main"}, "Easy", function(choice)
end)
Tab:AddMultiDropdown("Left", "Select Godmode", {"Health INF", "Immortal", "GAY"}, "Easy", function(choice)
end)
Tab:AddToggle("Left", "Start Farming", false, function(v)
end)
Tab:AddToggle("Left", "Bring Mob", true, function(v)
end)
Tab:AddToggle("Left", "Start God Mode", false, function(v)
end)
